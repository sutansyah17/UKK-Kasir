...
if (isset($_POST['tambah'])) {
    ...
    $sql = $koneksi->query("INSERT INTO pelanggan (PelangganID, NoMeja, NamaPelanggan) VALUES ('$id_transaksi_baru', '$nomeja', '$nama')");
    ...
    foreach ($menu_jumlah as $i => $item) {
        ...
        $sql4 = $koneksi->query("UPDATE produk SET terjual = terjual + $jumlah  WHERE ProdukID = '$produk_id'");
    }
